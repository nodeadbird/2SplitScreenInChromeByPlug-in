...
var Split = function (ids, options) {
    ...
    //2017-11-17 Yang ADD for 根据div尺寸动态修改图片SRC
    var fatherDivId = options.fatherDivId;
    var childDivId = options.childDivId;
    var childImageId = options.childImageId;
    var childImageBigSrc = options.childImageBigSrc;
    var childImageSmallSrc = options.childImageSmallSrc;
    //2017-11-17 Yang ADD for 根据div尺寸动态修改图片SRC
    ...
    function stopDragging () {
        ...
        //2017-11-17 Yang ADD for 根据div尺寸动态修改图片SRC 
        if(typeof(fatherDivId)!="undefined" && typeof(childDivId)!="undefined" && typeof(childImageId)!="undefined" && typeof(childImageBigSrc)!="undefined" && typeof(childImageSmallSrc)!="undefined"){
            console.log(fatherDivId+childDivId+childImageId+childImageBigSrc+childImageSmallSrc);
            var fatherDivWidth = $("#"+fatherDivId).width();
            var childDivWidth = $("#"+childDivId).width();
            var per = childDivWidth / fatherDivWidth;
            console.log(per);
            if(per > 0.5){
                $("#"+childImageId).attr("src", childImageBigSrc);
            }else{
                $("#"+childImageId).attr("src", childImageSmallSrc);
            }
        }else{
            console.log("修改图片尺寸参数为空");
        }
        //2017-11-17 Yang ADD for 根据div尺寸动态修改图片SRC
